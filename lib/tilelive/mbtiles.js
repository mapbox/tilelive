...
MBTiles.prototype.insertTile =  function(tile, x, y, z) {
    var that = this;
    this.open(function() {
        that.db.execute('INSERT INTO tiles (tile_data, zoom_level, tile_column, tile_row) VALUES (?, ?, ?, ?);', [tile, x, y, z], function(err) {
            err && console.log(err);
        });
    });
}
