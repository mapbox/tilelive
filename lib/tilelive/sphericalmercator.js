...
/**
 * Convert tile xyz value to long/lat aka wgs 84
 *
...
SphericalMercator.prototype.xyz_to_envelope = function(x, y, zoom, tms_style) {
    ...
    if (!this.mercator) {
        this.mercator = new require('mapnik').Projection('+proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +no_defs +over');
    }
