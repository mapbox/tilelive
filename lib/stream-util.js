...
function multiwrite(stream, callback, put) {
    console.log("tilelive.copy muiltwrite function");
    ...
    console.log("tilelive.copy multiwrite  _multiwriting: " + stream._multiwriting);
    ...
    put(function(err) {
        console.log("tilelive.copy multiwrite put");
        stream._multiwriting--;
        console.log("tilelive.copy multiwrite put _multiwriting: " + stream._multiwriting);
        if (err) stream.emit('error', err);
        stream.emit('_write');

        if (!stream._multiwriting) {
            console.log("emit _writeEmpty");
            stream.emit('_writeEmpty');
        }
    });
}
