...
function Put(source, options) {
    ...
    //     console.log("Put unpipe handler");
    //     return s._multiwriting ? s.once('_writeEmpty', stop) : stop();
